  ...
  return (
    <div className={`d-flex justify-content-center ${mediaQuery ? 'mt-5' : 'mt-2'}`}>
      <div className="position-relative">
        {pressed ? <div className="z-3 position-absolute top-0 start-0 bottom-0 end-0 bg-white opacity-75"></div> : undefined}
        <Webcam
          audio={false}
          height={height}
          ref={selfieRef}
      ...
      <CameraButton isPressed={isPressed} notPressed={notPressed} selfie={selfieRef} userId={userId}/>
    </div>
  )
};
